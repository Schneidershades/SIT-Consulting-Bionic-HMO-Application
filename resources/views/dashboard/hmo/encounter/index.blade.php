...
<!-- Breadcrumb-->
 <div class="row pt-2 pb-2">
    <div class="col-sm-9">
	    <h4 class="page-title">My HCP Encounters</h4>
	    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javaScript:void();">{{auth()->user()->userable->hmo_name}}</a></li>
        <li class="breadcrumb-item"><a href="javaScript:void();">Dashboard</a></li>
        <li class="breadcrumb-item active" aria-current="page">My HCP Encounters</li>
     </ol>
    </div>
 	<div class="col-sm-3">
      ...
      <div class="card-body">
        <div class="media">
          <div class="media-body text-left">
            <h4 class="text-white">
              @foreach($hcps as $hcp)
                @foreach($hcp->hcp->encounters as $encounter)
                  {{$hcp->hcp->encounters->count() ? $hcp->hcp->encounters->count() : 0 }}
                @endforeach
              @endforeach
            </h4>
...
<div class="row">
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header"><i class="fa fa-table"></i> All Encounter 
      </div>
