...
<!-- Breadcrumb-->
 <div class="row pt-2 pb-2">
    <div class="col-sm-9">
	    <h4 class="page-title">Enrollee:  {{$enrollee->first_name}} {{$enrollee->middle_name}} {{$enrollee->last_name}} in  {{$enrollee->hcp->hcp_name}} Details</h4>
	    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javaScript:void();">{{auth()->user()->userable->hmo_name}}</a></li>
        <li class="breadcrumb-item"><a href="javaScript:void();">Dashboard</a></li>
        <li class="breadcrumb-item active" aria-current="page">Enrollee:  {{$enrollee->first_name}} {{$enrollee->middle_name}} {{$enrollee->last_name}} in  {{$enrollee->hcp->hcp_name}} Details</li>
     </ol>
    </div>
 	<div class="col-sm-3">
...
<div class="row">
	<div class="col-lg-12 mx-auto">
		<div class="card">
			<div class="card-body">
				<div class="card-title text-uppercase "><i class="fa fa-address-book-o"></i> Enrollee:  {{$enrollee->first_name}} {{$enrollee->middle_name}} {{$enrollee->last_name}} in  {{$enrollee->hcp->hcp_name}} Details</div>
				<hr>
				<div class="row">
					<div class="col-md-4">
					...
					<div class="col-md-4">
						...
						<h5>{{$enrollee->hcp ? $enrollee->hcp->hcp_name : ''}}</h5>
					</div>
					<hr>
					<div class="col-md-4">
				...
				<div class="card-title text-uppercase "><i class="fa fa-address-book-o"></i> Dependants of {{$enrollee->first_name}} {{$enrollee->middle_name}} {{$enrollee->last_name}} in  {{$enrollee->hcp->hcp_name}} Details</div>
				<hr>
