...
<!-- Breadcrumb-->
 <div class="row pt-2 pb-2">
    <div class="col-sm-9">
      <h4 class="page-title">New drug registration</h4>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javaScript:void();">{{auth()->user()->userable->hmo_name}}</a></li>
        <li class="breadcrumb-item"><a href="javaScript:void();">Dashboard</a></li>
        <li class="breadcrumb-item active" aria-current="page">New drug registration</li>
     </ol>
    </div>
  <div class="col-sm-3">
     <div class="btn-group float-sm-right">
      <a href="{{route('hmo-tariffs.index')}}"><button type="button" class="btn btn-outline-primary waves-effect waves-light"><i class="fa fa-left mr-1"></i> Back</button></a>
    </div>
  </div>
</div>
<!-- End Breadcrumb-->
...
<div class="row">
  <div class="col-lg-12 mx-auto">
    <div class="card bg-dark shadow-dark">
      <div class="card-body">
        <div class="card-title text-uppercase text-white"><i class="fa fa-address-book-o"></i>New drug </div>
        <hr>
        <form class="color-form" method="POST" action="{{route('hmo-tariffs.store')}}" enctype="multipart/form-data">
          @csrf
            ...
            <div data-repeater-list="hcp_drug_details">
              <div data-repeater-item class="form-group row">
                ...
                <div class="form-group col-md-6">
                  <label for="input-25">Drug Name</label>
                  <input name="name" type="text" class="form-control" id="input-25" placeholder="Enter drug name" required="">
                </div>

                <div class="form-group col-md-6">
                  <label for="input-25">Drug Dosage Form</label>
                  <input name="dosage_form" type="text" class="form-control" id="input-25" placeholder="Enter dosage form" required="">
                </div>

                <div class="form-group col-md-6">
                  <label for="input-25">Drug Strength</label>
                  <input name="strength" type="text" class="form-control" id="input-25" placeholder="Enter drug strength" required="">
                </div>

                <div class="form-group col-md-6">
                  <label for="input-25">Drug Persentation</label>
                  <input name="presentation" type="text" class="form-control" id="input-25" placeholder="Enter drug presentation" required="">
                </div>
                
                <div class="form-group col-md-6">
                  <label for="input-26">drug Category</label>
                  <select class="form-control single-select" name="parent_id" required="">
                    <option value="">---Select Parent drug Category---</option>
                    @foreach($parent_drugs as $drug)
          ...
          <div class="form-group">
            <button type="submit" class="btn btn-link bg-white text-dark shadow px-5"><i class="icon-lock"></i> Register Drug</button>
          </div>
