				...
				<form class="color-form" method="POST" action="{{route('bills.store')}}" enctype="multipart/form-data">
					...
					<div class="form-group row">
						...
						<div class="form-group col-md-3">
							...
							<select class="form-control single-select" name="enrollee_id" required>
						...
						<div class="form-group col-md-3">
							...
							<select class="form-control single-select" name="hcp_id" required>
					...
					<div class='repeater'>
						...
						<div data-repeater-list="hcp_service_details">
							<div data-repeater-item class="form-group row">
								<!-- <div class="col-md-12">
									<div class="card-title text-white text-center"><i class="fa fa-address-book-o"></i> New Fee For Service / Item</div><br>
								</div> -->
								
								<div class="form-group col-md-12">
									<label>Fee for service</label>
									<select class="form-control single-select" name="treatment_id">
								...
								<!-- <div class="form-group col-md-3">
									<label for="input-26">Quantity</label>
									<input name="description" type="number" min="0" class="form-control" id="input-26" placeholder="tariff Quantity">
								</div> -->
								<div class="form-group col-md-12">
						...
						<div data-repeater-list="hcp_drug_details">
							<div data-repeater-item class="form-group row">
								...
								<div class="form-group col-md-12">
									...
									<select class="form-control single-select" name="drug_id">
