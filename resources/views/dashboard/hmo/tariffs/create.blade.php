...
<!-- Breadcrumb-->
 <div class="row pt-2 pb-2">
    <div class="col-sm-9">
      <h4 class="page-title">New tariff Registration</h4>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javaScript:void();">{{auth()->user()->userable->hmo_name}}</a></li>
        <li class="breadcrumb-item"><a href="javaScript:void();">Dashboard</a></li>
        <li class="breadcrumb-item active" aria-current="page">New tariff Registration</li>
     </ol>
    </div>
  <div class="col-sm-3">
...
<div class="row">
  <div class="col-lg-12 mx-auto">
    <div class="card bg-dark shadow-dark">
      <div class="card-body">
        <div class="card-title text-uppercase text-white"><i class="fa fa-address-book-o"></i>New tariff </div>
        <hr>
        <form class="color-form" method="POST" action="{{route('hmo-tariffs.store')}}" enctype="multipart/form-data">
          ...
          <div class='repeater'>
            ...
            <div data-repeater-list="hcp_tariffs_details">
              <div data-repeater-item class="form-group row">

                <div class="form-group col-md-6">
                  <label for="input-25">Tariff Code</label>
                  <input name="code" type="text" class="form-control" id="input-25" placeholder="Enter tariff code" required="">
                </div>

                <div class="form-group col-md-6">
                  <label for="input-25">Tariff Description</label>
                  <input name="description" type="text" class="form-control" id="input-25" placeholder="Enter tariff description" required="">
                </div>
                
                <div class="form-group col-md-6">
                  <label for="input-26">tariff Category</label>
                  <select class="form-control single-select" name="parent_id" required="">
                    <option value="">---Select Parent tariff Category---</option>
                    @foreach($parent_tariffs as $tariff)
                    <option value="{{$tariff->id}}">{{$tariff->tariff_code}}-{{$tariff->description}}</option>
                    @endforeach
                  </select>
                </div>
            ...
            <div class="text-right">
              <button data-repeater-create type="button" class="btn btn-primary waves-effect waves-light m-1"> + Add Tariff </button>
            </div>
          </div>

          <div class="form-group">
            <button type="submit" class="btn btn-link bg-white text-dark shadow px-5"><i class="icon-lock"></i> Register Tariff</button>
          </div>
