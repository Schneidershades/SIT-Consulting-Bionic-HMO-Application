...
<header class="topbar-nav">
 <nav class="navbar navbar-expand fixed-top gradient-ibiza">
  <ul class="navbar-nav mr-auto align-items-center">
    ...
    <li class="nav-item ">
      <h3 class="text-white d-none d-md-block text-uppercase">{{auth()->user()->userable->hcp_name}} - {{auth()->user()->userable_type}}</h3>
  ...
  <ul class="navbar-nav align-items-center right-nav-link">
    ...
    <li class="nav-item">
      <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" data-toggle="dropdown" href="#">
        <span class="user-profile"><img src="{{ URL::to('assets/images/avatars/avatar-1.png')}}" class="img-circle" alt="user avatar"></span>
      </a>
      <ul class="dropdown-menu dropdown-menu-right animated fadeIn">
