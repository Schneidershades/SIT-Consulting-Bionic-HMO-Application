...
<div class="row pt-2 pb-2">
    <div class="col-sm-9">
	    <h4 class="page-title">New HCP Encounter</h4>
	    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javaScript:void();">{{auth()->user()->userable->hcp_name}}</a></li>
        <li class="breadcrumb-item"><a href="javaScript:void();">Dashboard</a></li>
        <li class="breadcrumb-item active" aria-current="page">New HCP Encounter</li>
     </ol>
    </div>
 	<div class="col-sm-3">
	...
	<div class="col-lg-12 mx-auto">
		<div class="card bg-dark shadow-dark">
			<div class="card-body">
				...
				<hr>
				<form class="color-form" method="POST" action="{{route('hcp-encounters.store')}}" enctype="multipart/form-data">
					@csrf
					<div class='repeater'>
