						...
						<div data-repeater-list="hcp_assessments_details">
							<div data-repeater-item class="form-group row">
								...
								<div class="form-group col-md-12">
									...
									<textarea name="remarks" class="form-control" id="input-25"  cols="30" rows="4"></textarea>
								</div>
								<div class="form-group col-md-12">
									<label for="input-25">Remarks</label>
									<textarea name="recommendations" class="form-control" id="input-25"  cols="30" rows="4"></textarea>
								</div>
								<div class="form-group col-md-12">
