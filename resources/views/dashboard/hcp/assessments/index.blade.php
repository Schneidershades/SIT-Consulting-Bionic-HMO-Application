...
<!-- Breadcrumb-->
 <div class="row pt-2 pb-2">
    <div class="col-sm-9">
	    <h4 class="page-title">All HCP Assessments in {{auth()->user()->userable->hcp_name}}</h4>
	    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javaScript:void();">Bionic</a></li>
        <li class="breadcrumb-item"><a href="javaScript:void();">Dashboard</a></li>
        <li class="breadcrumb-item active" aria-current="page"> All HCP Assessments in {{auth()->user()->userable->hcp_name}}</li>
     </ol>
    </div>
 	<div class="col-sm-3">
...
<div class="row">
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header"><i class="fa fa-table"></i> All HCP Assessments in {{auth()->user()->userable->hcp_name}}
      </div>
        ...
        <div class="table-responsive">
          <table id="example" class="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                <td>{{$assessment->hmo->hmo_code}} - {{$assessment->hmo->hmo_name}}</td>
