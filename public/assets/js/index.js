...
// chart 5
 var ctx = document.getElementById('dash-chart-5').getContext('2d');
  ...
  // chart 7
 var ctx = document.getElementById('dash-chart-7').getContext('2d');
...
jQuery('#dashboard-map').vectorMap(
{
  ...
  // chart 16
  var ctx = document.getElementById("dash-chart-16").getContext('2d');
...
// chart 17
var ctx = document.getElementById("dash-chart-17").getContext('2d');
...
// chart 18
var ctx = document.getElementById("dash-chart-18").getContext('2d');
    ...
    var gradientStroke11 = ctx.createLinearGradient(0, 0, 0, 300);
      ...
      var myChart = new Chart(ctx, {
        type: 'doughnut',
        data: {
          labels: ["Encounters", "T-Shirts", "Shoes"],
          datasets: [{
            backgroundColor: [
              gradientStroke11,
              gradientStroke12,
 ...
 // Index Notification
	 ...
	 // function info_noti(){
		...
		// msg: 'This is Light Dashboard with Color'
		// });
	 //  } 