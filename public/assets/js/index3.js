...
// chart 5
 var ctx = document.getElementById('dash3-chart-5').getContext('2d');
   ...
   // chart 6
    var ctx = document.getElementById("dash3-chart-6").getContext('2d');
  ...
  // chart 7
 var ctx = document.getElementById('dash3-chart-7').getContext('2d');
...
jQuery('#dashboard-map').vectorMap(
{
  ...
  // chart 16
  var ctx = document.getElementById("dash3-chart-16").getContext('2d');
...
// chart 17
var ctx = document.getElementById("dash3-chart-17").getContext('2d');
...
// chart 18
var ctx = document.getElementById("dash3-chart-18").getContext('2d');
 ...
 // Index Notification
	 ...
	 function info_noti(){
		...
		msg: 'This is Transparent Dashboard'
		});
	  } 